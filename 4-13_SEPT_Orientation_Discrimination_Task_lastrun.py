...
expName = '4-13_SEPT_Orientation_Discrimination_Task'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Lenovo\\Documents\\MON 2024-25\\FULL_TERM\\PSY-310_LAB_IN_PSYCHOLOGY\\4-13_SEPTEMBER_ORIENTATION_DISCRIMINATION\\4-13_SEPT_Orientation_Discrimination_Task_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text_2 = visual.TextStim(win=win, name='text_2',
        text='The task is to press the following keys in order to respond to the orientation. There are only two decisions to make.\na= when no tilt\nz= when tilt\nIf you would like to participate in the task, please press SPACE to start',
        font='Cooper Black',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    grating = visual.GratingStim(
        ...
        ori=tilt, pos=(0, 0), size=(0.2, 0.2), sf=5.0, phase=0.0,
    ...
    for thisTrial in trials:
        ...
        while continueRoutine:
            ...
            if key_resp.status == STARTED and not waitOnFlip:
                theseKeys = key_resp.getKeys(keyList=['a','z'], ignoreKeys=["escape"], waitRelease=False)
    ...
    # keep track of which components have finished
    Thank_youComponents = [text, image]
