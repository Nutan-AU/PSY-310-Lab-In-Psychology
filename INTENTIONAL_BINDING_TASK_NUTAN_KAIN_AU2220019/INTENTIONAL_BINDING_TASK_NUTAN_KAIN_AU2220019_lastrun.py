...
expName = 'INTENTIONAL_BINDING_TASK_NUTAN_KAIN_AU2220019'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Lenovo\\Documents\\MON 2024-25\\FULL_TERM\\PSY-310_LAB_IN_PSYCHOLOGY\\8-7_NOVEMBER_INTENTIONAL_BINDING\\INTENTIONAL_BINDING_TASK_NUTAN_KAIN_AU2220019_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='Hello\nIn this task you have to press the space-bar when the green circle appears which will be followed by a sound.  After hearing the sound, you shall report the time at which you think the sound appeared, in milliseconds from 0-1000. \n\nIf you have read the guidelines and would like to participate, please press the Spacebar. ',
        font='Monospace',
    ...
    textbox = visual.TextBox2(
         ...
         color=[0.6941, 0.4980, 0.6941], colorSpace='rgb',
         opacity=None,
    ...
    button = visual.ButtonStim(win, 
        text='Submit ', font='Monospace',
        pos=(0, -0.3),
        letterHeight=0.05,
        size=(0.3, 0.1), borderWidth=0.0,
        fillColor=[-1.0000, 0.0039, 0.0039], borderColor=[0.8824, 1.0000, 1.0000],
    ...
    text_2 = visual.TextStim(win=win, name='text_2',
        text='Thank Your for Your Participation.\nThe experiment has ended. ',
        font='Monospace',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    guidelinesComponents = [text, key_resp_2]
    ...
    trials = data.TrialHandler(nReps=33.0, method='random', 
        ...
        trialList=data.importConditions('DELAY_FREQ_CONDITIONS_EXCEL_FILE_INTENTIONAL_BINDING.xlsx'),
    ...
    for thisTrial in trials:
        ...
        display_text.setText('Report the delay between the key press and beep sound (0-1000) in ms\nClick submit after entering the value')
        textbox.reset()
    ...
    while continueRoutine and routineTimer.getTime() < 0.35:
        ...
        if text_2.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > text_2.tStartRefresh + 0.35-frameTolerance:
                # keep track of stop time/frame for later
