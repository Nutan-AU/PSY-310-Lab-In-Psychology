...
expName = 'MOTOR_SEQUENCE_LEARNING_NUTAN_KAIN_AU2220019'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Lenovo\\Documents\\MON 2024-25\\FULL_TERM\\PSY-310_LAB_IN_PSYCHOLOGY\\6-11_OCT_MOTOR_SEQUENCE_LEARNING_NUTAN_KAIN_AU2220019\\MOTOR_SEQUENCE_LEARNING_NUTAN_KAIN_AU2220019_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text_2 = visual.TextStim(win=win, name='text_2',
        text='In this experiment, you will be shown four vertical lines from left to right. There are four keys, one associated with each line. A triangle will be presented over a line. The task is to press the key associated with the line on which the triangle has been presented. \n\nStarting from left to right,\nfor first line, press Z\nfor second line, press X\nfor third line, press C\nfor fourth line, press V\n\nIf you would like to participate, please press SPACEBAR',
        font='Cooper Black',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    _key_resp_2_allKeys = []
    # keep track of which components have finished
    guidelinesComponents = [text_2, key_resp_2]
    ...
    trials = data.TrialHandler(nReps=50.0, method='sequential', 
        ...
        trialList=data.importConditions('6-11_OCTOBER_MOTOR_SEQUENCE_LEARNING.csv'),
